...
//             try {
//                 const response = await sendData("GET", `user-analytics?page=${page}&limit=${limit}&keyword=${keyword}`, true);
...
//                 <input type="text" placeholder="Search by user name" onChange={handleSearch} />
